...
int main()
{
	auto *activation = (activationPtr<float64>) rapid::neural::activation::relu<float64>;
	auto *derivative = (activationPtr<float64>) rapid::neural::activation::reluDerivative<float64>;

	auto optim1 = new rapid::neural::optim::SGDMomentum<float64>(0.05);
	auto optim2 = new rapid::neural::optim::SGDMomentum<float64>(0.05);
